#!/usr/bin/env bash
# Global Grounds Coffee, build checks
set -u
...
printf "Global Grounds Coffee, build checks\n"
printf "===================================\n"
printf "project: %s\n" "$PROJ_DIR"
printf "host:    %s\n" "$HOST"
...
endash_files=$(grep -lE $'\xe2\x80\x93|&ndash;|&mdash;' index.html menu.html about.html visit.html style.css main.js 2>/dev/null || true)
